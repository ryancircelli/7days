...
export const ColorPicker = ({newOptions, settings, prop, option, updateSettings, getSavedSettings}) => {
  ...
  return (  
    ...
    >
      <button 
        className="flex justify-center items-center w-12 py-4 rounded-lg bg-white hover:brightness-95"
